  ...
  >
    ...
    >
      ...
      <div class="text-center space-y-2 text-white/80 mb-6 flex flex-col">
        ...
        <LazyNuxtLink v-if="user.role !== 'user' && photographer" :to="'/photographers/'+photographer.id" class="text-gray-400 hover:text-white duration-200">Перейти до профілю фотографа</LazyNuxtLink>
